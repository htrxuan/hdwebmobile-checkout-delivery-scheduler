...
final class HDDTS_Hub
{
    ...
    public static function render_overview()
    {
        ...
        $plugins = array(
            ...
            array('name' => 'Checkout Delivery Scheduler', 'file' => 'hdwebmobile-delivery-date-time-slot/hdwebmobile-delivery-date-time-slot.php', 'description' => 'Let customers pick a delivery date and time slot at checkout.'),
